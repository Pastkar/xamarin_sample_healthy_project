...
namespace AssayMe.Droid.Views
{
    ...
    [Register("assayMe.droid.views.AboutView")]
    public class AboutView : BaseFragment<AboutViewModel>
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            tv_privacy_policy = view.FindViewById<TextView>(Resource.Id.tv_about);
            InitPrivacyPolicy();
        }
        #endregion
        ...
        private void InitPrivacyPolicy()
        {
            ...
            word.SetSpan(new ForegroundColorSpan(Color.White), 0, word.Length(), SpanTypes.ExclusiveExclusive);
            ...
            foreach (var item in ViewModel.UnderLineTexts)
            {
                ...
                var click = new PrivacyPolicySpan(item.Item2 == Core.Models.Enums.PrivacyPolicyType.PP ?
                    ViewModel.GoPrivacyPolicyCommand : ViewModel.GoEULACommand,Color.White);
